...
module.exports = {
  ...
  onChat: async function ({ event, message }) {
    ...
    const captions = [
      ...
      "👉আমার বস ♻️ ꜰᴍᴢ ʀᴀʏʜᴀɴ এখন বিজি আছে । তার ইনবক্সে এ মেসেজ দিয়ে রাখো https://www.facebook.com/share/1FAvDV4oXK/🔰 ♪√বস ফ্রি হলে আসবে🧡😁😜🐒",
      ...
      "Mantion_না দিয়ে বস রায়হান এর সাথে সিরিয়াস প্রেম করতে চাইলে ইনবক্স",
      "বস রায়হান কে মেনশন দিসনা পারলে একটা জি এফ দে",
      "বাল পাকনা Mantion_দিস না বস রায়হান প্রচুর বিজি আছে 🥵🥀🤐",
      "চুমু খাওয়ার বয়স টা আমার বস রায়হান চকলেট🍫খেয়ে উড়িয়ে দিল 🤗"
    ];
